...
- **incident_report.md** :- a short, high-level report: what happened, timeline, IOCs, and impact. Written for a reader who wants the outcome, not the process.
- **investigation_writeup.md** :- the full methodology: reasoning, tools used, dead ends, and evidence for each conclusion.
